...
import { seedStripeProducts } from './stripe/seedProducts';
import { seedWhitelist } from './seedWhitelist';
...
seedWhitelist().catch((err: any) => console.error('Whitelist seed error:', err));
